/**
 * @file SolarExplorer-DevInit_F2803x.c
 * @author Ryan Rodriguerz
 * @date 27 Jan 2015
 * @brief Device level inits for F2803x series
 *
 * This File includes devie level configuration for the TI Piccolo F2803x.
 * Typically called once during device start-up.
 */
...
/**
 * @Brief Device level initializations for the F28035
 *
 * This low-level initialization first diables the watchdog timer, then the interrupt enables. After this is done,
 * all interrupt flags are cleared with calls to PieCntlInit() and PieVectInit()
 */
void DeviceInit(void)
{
...
//This was commented form TI code, probably from an odler implementation of PLL inits.
//Use the function below instead.
//void InitPll(Uint16 val, Uint16 clkindiv)

/**
 * @brief PLL Init
 * @param val PLL divisor value
 * 
...
/**
 * @brief initializes Flash Control Registers
 *
 * @warning This function MUST be executed out of RAM. Executing it
...
/**
 * @brief Copy memory to differne tlocation
 * 
 * This function will copy the specified memory contents from
 * one location to another.
 * 
 * @warning No checks are made for invalid memory locations or that the
 * end address is > then the first start address.
 * 
 * @param SourceAddr    Pointer to the first word to be moved
